...
class TaskJson {
  ...
  static Map<String, dynamic> taskToJson(Task task) => {
        ...
        'timeNeeded': task.timeNeeded.inSeconds,
        'endTime': task.endTime.toIso8601String(),
        'location': task.location,
        'summary': task.summary,
        'isBreakable': task.isBreakable,
        'type': task.type.name,
        ...
        'blockArrangements': task.blockArrangements,
  ...
  static Task? taskFromJson(Map<String, dynamic> json) {
    ...
    return Task(
      ...
      timeNeeded: Duration(seconds: _seconds(json['timeNeeded'], 3600)),
      endTime: endTime,
      location: '${json['location'] ?? ''}',
      summary: '${json['summary'] ?? ''}',
      isBreakable: json['isBreakable'] == true,
      ...
      blockArrangements: json['blockArrangements'] != false,
