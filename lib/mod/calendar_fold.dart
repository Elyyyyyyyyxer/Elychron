...
class CalendarFoldGesture {
  ...
  /// 太大则要划很久才有反应。28 差不多是有意识地划一下。
  static const double threshold = 28;

  /// 已经到顶了的容差， 滚动位置基本贴着 0 就算到顶。
